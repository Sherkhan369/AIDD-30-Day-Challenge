...
Just like every house needs bricks, cement, sand, even if houses look different…
your project also has basic rules that never change.
...
You explain your idea, what you want to make, and how it should work.
...
Architecture – the big structure of the project

Implementation steps – how to build it

Dependencies – things needed to complete it

Design decisions – why you choose certain ways
...
So you divide the plan into small, simple tasks.

Meaning:
Small tasks help AI complete work step by step without mistakes.

# implement — Start building the project
